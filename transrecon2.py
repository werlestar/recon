...
def upload_file():
    if request.method == 'POST':
        ...
        if file1 and file2:
            ...
            # Render a template with JavaScript to open result in a new tab
            return render_template('open_result_in_new_tab.html', vf_unika=vf_uniques, bo_unika=bo_uniques)
